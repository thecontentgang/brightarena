        ...
        <div className="max-w-7xl w-full mx-auto">
          ...
          <div className="max-w-4xl">
            ...
            <p className="font-body text-white/90 text-sm md:text-base leading-[1.8] max-w-xl">
              We create stylish and comfortable interiors with premium materials, modern designs, and elegant finishes that bring beauty and luxury to every corner of your space.
            </p>
          </div>
